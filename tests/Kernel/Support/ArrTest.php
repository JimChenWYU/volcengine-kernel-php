...
namespace Volcengine\Tests\Kernel\Support;

use stdClass;
use Volcengine\Kernel\Support\Arr;
use Volcengine\Kernel\Support\Collection;

class ArrTest extends \Volcengine\Tests\TestCase
{
    public function testAdd()
    {
        $array = Arr::add(['name' => 'volcengine'], 'price', 100);
        $this->assertSame(['name' => 'volcengine', 'price' => 100], $array);
    }
    ...
    {
        list($keys, $values) = Arr::divide(['name' => 'volcengine']);
        $this->assertSame(['name'], $keys);
        $this->assertSame(['volcengine'], $values);
    }
    ...
    {
        $array = ['name' => 'volcengine', 'price' => 100];
        $array = Arr::except($array, ['price']);
        $this->assertSame(['name' => 'volcengine'], $array);
    }
    ...
    {
        $array = ['name' => 'volcengine', 'price' => 100, 'orders' => 10];
    ...
    public function testPull()
    {
        ...
        $this->assertSame('volcengine', $name);
    ...
    public function testForget()
    {
        ...
        // Only works on first level keys
        $array = ['i@example.com' => 'Joe', 'i@volcengine.com' => 'Jane'];
        Arr::forget($array, 'i@example.com');
        $this->assertSame(['i@volcengine.com' => 'Jane'], $array);
        // Does not work for nested keys
